...
const comps = [Button, Input, Row, Col, Container, Header, Aside, Main, Footer, Menu, Submenu, MenuItemGroup, MenuItem, Scrollbar,
  ...
  Upload, Tabs, TabPane, RadioGroup, Radio, Result, Cascader, Collapse, CollapseItem]
